...
st.plotly_chart(fig_count_sex,use_container_width=True)
...
st.plotly_chart(fig_line_charges_age, use_container_width=True)
...
st.plotly_chart(fig_line_charges_age_skyblue, use_container_width=True)
